...
*			UPLOAD FUNCTIONS		  			*
***********************************/
router.route('/user/upload').post(pandicamAuth.checkGroupAuth,	multer({dest: '/app/pandicam/uploads/',fileFilter:pandicamfileManager.uploadLimiter}).single('file'),pandicamfileManager.upload);
router.route('/user/addUserPic').post(pandicamAuth.checkAuth,multer({dest: '/app/pandicam/uploads/',fileFilter:pandicamfileManager.uploadLimiter}).single('file'),pandicamfileManager.addUserPic);
